...
<footer class="bg-background mt-24">
	<div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-24">
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
			<div>
				...
				<p class="max-w-md sm:max-w-xs mt-6 text-center leading-relaxed text-gray-500 sm:text-left">
				...
				<ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
					<li>
						<a href="/" rel="noreferrer" target="_blank" class="text-teal-700 transition hover:text-teal-700/75">
							...
							<svg class="h-6 w-6" viewBox="0 0 24 24" aria-hidden="true" fill={$colorPick}>
								<path
									fill-rule="evenodd"
					...
					<li>
						<a href="/" rel="noreferrer" target="_blank" class="text-teal-700 transition hover:text-teal-700/75">
							...
							<svg class="h-6 w-6" fill={$colorPick} viewBox="0 0 24 24" aria-hidden="true">
								<path
									fill-rule="evenodd"
			...
			<div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
				<div class="text-center sm:text-left">
					...
					<ul class="mt-8 space-y-4 text-sm">
						<li>
							<a class="text-gray-700 transition hover:text-gray-700/75" href="/"> Company History </a>
						</li>
						...
						<li>
							<a class="text-gray-700 transition hover:text-gray-700/75" href="/"> Employee Handbook </a>
						</li>
				...
				<div class="text-center sm:text-left">
					...
					<ul class="mt-8 space-y-4 text-sm">
						<li>
							<a class="text-gray-700 transition hover:text-gray-700/75" href="/"> Web Development </a>
						</li>
				...
				<div class="text-center sm:text-left">
					...
					<ul class="mt-8 space-y-4 text-sm">
						...
						<li>
							<a class="group flex justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end" href="/">
				...
				<div class="text-center sm:text-left">
					...
					<ul class="mt-8 space-y-4 text-sm">
						...
						<li class="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
							...
							<address class="-mt-0.5 flex-1 not-italic text-gray-700">213 Lane, London, United Kingdom</address>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="mt-12 border-t border-gray-100 pt-6">
			<div class="text-center sm:flex sm:justify-between sm:text-left">
				...
				<p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2022 Guillaume Giordano</p>
			</div>
		</div>
	</div>
</footer>
